...
import { Landmark, ShieldCheck, CreditCard, Users, Settings, LogOut } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <div className="w-64 bg-[#0B132B] text-slate-300 flex flex-col shadow-2xl z-20 shrink-0">
