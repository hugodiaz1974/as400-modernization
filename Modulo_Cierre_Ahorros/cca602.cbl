...
VG    *       PERFORM TERMINAR.
      ...
      *----------------------------------------------------------------
       GRABAR-CCAMAEAHO.
           ADD      W-INTERES TO   INTREM OF REG-MAESTR
           ADD      W-INTERES TO   CREDIA OF REG-MAESTR
           ADD      W-RETENCI TO   RETREM OF REG-MAESTR
           ADD      W-RETENCI TO   DEBDIA OF REG-MAESTR
           ...
           IF W-INTERES > ZEROS
              MOVE LK-FECHA-HOY    TO FULPAG OF REG-MAESTR
           END-IF.
      *
      ...
      *----------------------------------------------------------------
       LLENAR-FIJOS.
           ...
           MOVE LK-FECHA-AYER        TO FVALOR OF REG-MOVINT
